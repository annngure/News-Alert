...
class EverythingTest(unittest.TestCase):
    ...
    def test_init_id(self):
        self.assertEqual(self.news_everything.id, "null")

    def test_init_name(self):
        self.assertEqual(self.news_everything.name, "The Guardian")

    def test_init_author(self):
      
        self.assertEqual(self.news_everything.author, "Julia Kollewe")

    def test_init_title(self):
        self.assertEqual(self.news_everything.title, "Irn-Bru maker raises prices as UK inflation soars")

    def test_init_Image(self):
     
        self.assertEqual(self.news_everything.Image, "https://i.guim.co.uk/img/media/0adcb8d724386e3f524b399ad6b9028ac65fd283/0_116_3500_2100/master/3500.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=12dd7ec2853f62fba3ff23b070b3bbed",)

    def test_init_description(self):
     
        self.assertEqual(self.news_everything.description, "AG Barr blames rising production costs for price increase as it ups full-year sales and profit estimatesThe company behind Irn-Bru has revealed it is increasing its prices after its packaging, ingredients and energy-linked commodity costs jumped, as it raised…")
    def test_init_url(self):
     
        self.assertEqual(self.news_everything.url, "https://amp.theguardian.com/business/2022/feb/01/irn-bru-raises-prices-uk-inflation-ag-barr-sales-profit")

    def test_init_time(self):
        
        self.assertEqual(self.news_everything.time, "2022-02-01T08:55:30Z")
